...
import com.geekymanish.myapplication.databinding.ProgressLayoutViewBinding
...
internal class FooterLoadAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        return LoadStateViewHolder(
            ProgressLayoutViewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
    }

    class LoadStateViewHolder(val loadStateViewBinding: ProgressLayoutViewBinding) :
